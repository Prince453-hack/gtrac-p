    ...
    if (data && data.message !== "Something wrong happend") {
      ...
      if (selectedVehicleStatus === "not working") {
        filteredVehicles = filteredVehicles.filter((vehicle) => {
          ...
          const gpsInfoMode = gpsInfo?.mode;
          const elockInfoMode = elockInfo?.mode;

          if (gpsInfoMode && elockInfoMode) {
            return gpsInfoMode === "NOT WORKING" && elockInfoMode === "NOT WORKING";
          }

          if (gpsInfoMode) return gpsInfoMode === "NOT WORKING";
          if (elockInfoMode) return elockInfoMode === "NOT WORKING";

          return vehicle.gpsDtl.mode === "NOT WORKING";
        });
      }
