...
const Sidebar = ({ children }: { children: ReactNode }) => {
  ...
  const hideSidebarIcons = [833879, 833925, 833923, 833924, 833926].includes(Number(userId));
          ...
          >
            <Menu
              ...
              items={[
                        ...
                        : [
                            ...
                            : []),
                          {
                            ...
                            children: [
                              ...
                              Number(userId) === 3212 || Number(userId) === 833868 ||
                              ...
                              ...reportsForCurrentUser.map((report) => ({
                                ...
                                label: (
                                  <a
                                    href={`${report.url[report.url.length - 1] ===
                                      "="
                                      ? `${report.url}${extra}`
                                      : report.url
                                      }`}
                              ...
                              Number(userId) === 6258
                                ? {
                                    key: "overspeed-report-6258",
                                    icon: (
                                      <Image
                                        src={ReportsIcon}
                                        alt="overspeed report"
                                        width={14}
                                        height={14}
                                      />
                                    ),
                                    label: (
                                      <a
                                        href="https://gtrac.in/newtracking/load_search_data_next_eco.php?running_hr_val=&running_hr_val2=$&ideal_hr_val=&ideal_hr_val2=&km_val=&km_val2=&search_data=overspeed&over_speed_val=70&token=6173&userid=6258&extra=4&puserid=1"
                                        target="_blank"
                                        referrerPolicy="no-referrer"
                                      >
                                        Overspeed Report
                              ...
                              Number(userId) === 6461
                                ? {
                                    key: "geofence-consolidate-report-6461",
                                    icon: (
                                      <Image
                                        src={ReportsIcon}
                                        alt="geofence consolidate report"
                                        width={14}
                                        height={14}
                                      />
                                    ),
                                    label: (
                                      <a
                                        href="https://gtrac.in/newtracking/reports/poi_dashboard.php?report=Journey&token=6364&userid=6461&extra=0&puserid=1"
                                        target="_blank"
                                        referrerPolicy="no-referrer"
                                      >
                                        Geofence Consolidate Report
                                      </a>
                                    ),
                                  }
                                : null,
                ...
                isVideoTelematics
                  ? {
                    key: "/dashboard/dashcam-overview",
                    icon: (
                      <Image
                        src={DashcamOverview}
                        alt="dashcam overview icon"
                        width={14}
                        height={14}
                      />
                    ),
                    label: (
                      <a
                        href="/dashboard/dashcam-overview"
                        target="_blank"
                        referrerPolicy="no-referrer"
                      >
                        Dashcam Overview
