...
const Header = ({ navbarOpen, setNavbarOpen }: { navbarOpen: boolean; setNavbarOpen: React.Dispatch<React.SetStateAction<boolean>> }) => {
	return (
		<header className='w-full absolute top-0 left-0 p-10 flex z-20 '>
			{/* Logo */}
			<div className='text-white flex-grow z-20 flex'>
				<div>
					<Image src='/assets/images/common/logo.png' alt='logo' width='100' height='20' />
				</div>
			</div>
			{/* Hamburger Icon */}
